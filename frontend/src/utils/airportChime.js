/**
 * Airport Announcement Chime Synthesizer (Web Audio API)
 *
 ...
 *
 * Characteristics:
 * - Pure sinusoidal fundamental frequencies
 * - High inharmonic bell overtones (~2.76x physical chime bar mode)
 * - Octave harmonic (2.0x) for acoustic warmth
 * - Fast percussive strike attack (6ms) with natural exponential decay
 * - Overlapping note resonance creating a lush, professional ambient chord
 */
 ...
 *    Universally recognized in world-class international airports (e.g., Changi, Haneda, Heathrow).
 * 2. classic3: Crisp 3-tone ascending chime (C5 -> G5 -> C6).
 *    Classic Boeing / Euro-terminal PA attention signal.
 */
export const CHIME_PRESETS = {
  classic4: {
    ...
    notes: [
      { freq: 349.23, delay: 0.00, duration: 0.90, gain: 0.30 }, // F4
      { freq: 440.00, delay: 0.28, duration: 0.90, gain: 0.32 }, // A4
      { freq: 523.25, delay: 0.56, duration: 1.00, gain: 0.34 }, // C5
      { freq: 698.46, delay: 0.84, duration: 1.70, gain: 0.38 }, // F5 (lingering chord resolution)
    ],
  },
  classic3: {
    id: 'classic3',
    ...
    notes: [
      ...
      { freq: 783.99, delay: 0.35, duration: 0.95, gain: 0.34 }, // G5
      { freq: 1046.50, delay: 0.70, duration: 1.70, gain: 0.38 }, // C6
    ],
  },
};
 ...
 */
export function playAirportChime(presetKey = 'classic4') {
  try {
